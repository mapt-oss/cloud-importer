module github.com/mapt-oss/cloud-importer
...
require (
	...
	github.com/Azure/azure-sdk-for-go/sdk/resourcemanager/managementgroups/armmanagementgroups/v2 v2.0.0 // indirect
